...
import { generateObject as generateObject3, composeContext as composeContext3, ModelClass as ModelClass3 } from "@ai16z/eliza";
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-JCJWZXTQ.js");
  const signature_ = (() => {
