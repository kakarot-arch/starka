...
async function validateSlackConfig(runtime) {
  try {
    elizaLogger2.debug("Validating Slack configuration with runtime settings");
    const config = {
    ...
    if (error instanceof z.ZodError) {
      ...
      elizaLogger2.error("Configuration validation failed:", errorMessages);
...
import { Service as Service2, ServiceType as ServiceType2 } from "@ai16z/eliza";
