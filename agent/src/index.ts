...
// import { mainCharacter } from '../modeai.ts';
import {starka} from '../starka.ts';
...
export async function createAgent(
    ...
    return new AgentRuntime({
        ...
        plugins: [
            ...
            (getSecret(character, "STARKNET_PUBLIC_ADDRESS") &&
                getSecret(character, "0x02aee31e58181071c50aae8d84b6911fa1d793994cb767a68e54bb4a9d023cab")?.startsWith("0x"))
                ? starknetPlugin
                : null,
            (getSecret(character, "SOLANA_PUBLIC_KEY") ||
                (getSecret(character, "WALLET_PUBLIC_KEY") &&
